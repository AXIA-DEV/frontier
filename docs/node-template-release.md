...
> [Subtrate node template release process](https://github.com/axia-tech/substrate/blob/master/docs/node-template-release.md) -
...
2.  This release process has to be run in a github checkout Frontier directory with your work
    committed into `https://github.com/axia-dev/frontier/`, because the build script will check
...
4.  There are actually two packages in the Node Template, `frontier-node-template` (the node),
    ...
    remote repository, such as:
        ...
        git = 'https://github.com/axia-tech/substrate.git'
